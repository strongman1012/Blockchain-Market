...
contract PeakyBlinders is ERC20, Ownable {
    ...
    constructor() payable ERC20("PEAKY BLINDERS", "BLINDER") {
        ...
        uint256 totalSupply = 1 * 1e4 * 1e20;
        ...
        operationsAddress = address(0x15E3F1953842D57a08F74cdE29E2E16C36378628);
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 1) / 10000) / 1e20,
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 5) / 1000) / 1e20,
